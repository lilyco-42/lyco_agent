...
NOOP_TRAIN = ["讲个笑话", "今天几号", "写一首诗", "帮我算 1+1", "唱首歌", "写个爬虫", "推荐一部电影", "你是谁",
              "帮我订机票", "明天天气如何", "帮我写封邮件", "什么是黑洞", "帮我算一下 12*15", "今天股市怎么样",
...
def train_arm(model_id, out):
    ...
    args = TrainingArguments(output_dir=out, num_train_epochs=4, per_device_train_batch_size=16,
                             ...
                             report_to=[], lr_scheduler_type="cosine", warmup_ratio=0.03, disable_tqdm=True)
