...
> 📌 **后续做了正式 A/B 对照（24 题 × 8 类，SFT vs 原版底座，同量化同引擎同解码）
> → 见 `docs/eval-chat-slm-2026-09-22.md`：SFT 版 ✅7/⚠️7/❌10 vs 原版 ✅13/⚠️7/❌4
> ⇒ 聊天域也是净损害（与路由域 Δ_SFT −43.3pp 同构）；SFT 的真实收益只是「更快、无思考前缀」。**
