# -*- coding: utf-8 -*-
# FC 决策模型 GRPO V2 (7 工具) — 产 shipped qwen3_lyco_fc_v4 的基座。CloudStudio A10 /workspace 运行。含 NCCL stub + use_vllm=False (TRL/vllm 兼容补丁)。
...
OUT_DIR = "/workspace/qwen3_lyco_grpo_v2"
BASE_MODEL = "/workspace/qwen3_lyco_grpo/final"
MAX_STEPS = 200
...
TOOLS = [
    ...
    {"type": "function", "function": {
        "name": "llm_generate",
        "description": "通用大模型生成: 写文案/回答开放问题/续写, 不落文件",
        "parameters": {"type": "object", "properties": {
