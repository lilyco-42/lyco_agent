# -*- coding: utf-8 -*-
# FC GRPO V4 — 从 V3 续训, 撤 chat 双倍权重修 overcorrection + 扩短创作正例。BASE=grpo_v3/final, A10 运行。产 shipped qwen3_lyco_fc_v4。
...
OUT_DIR = "/workspace/qwen3_lyco_grpo_v4"
BASE_MODEL = "/workspace/qwen3_lyco_grpo_v3/final"
MAX_STEPS = 80
...
LLM_Q = ["帮我写一段产品文案", "续写这个故事", "给我写首诗", "翻译这段话",
         ...
         "帮我想个队名", "取个笔名", "起个店名", "写个活动标语",
         "给文章起标题", "帮产品起个名字", "想个游戏昵称", "起个群名"]
LLM_ARG = ["文案", "写", "故事", "诗"]
...
def train():
    ...
    cases = [
        ...
        ("怎么做红烧肉", None),
        ("帮我起个标题", "llm_generate"),
        ("cargo build 报错了怎么办", "lyv_knowledge"),
        ("帮我想个队名", "llm_generate"),
    ]
    hit = 0
    for q, exp in cases:
